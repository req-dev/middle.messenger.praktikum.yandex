  ...
  render() {
    ...
    <div class="chats-page__dialog-area">
        ...
        <div class="chats-page__dialog-area-reply-box">
            ...
            <form class="chats-page__dialog-area-reply-box-msg-form">
                <input type="text" class="chats-page__dialog-area-reply-box-msg-form-input" name="message" placeholder="Write a message...">
            </form>
            <button class="chats-page__dialog-area-reply-box-send-btn">
                <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 -960 960 960" fill="#FFFFFF"><path d="M647-440H160v-80h487L423-744l57-56 320 320-320 320-57-56 224-224Z"/></svg>
            </button>
        </div>
    </div>`;
  }
